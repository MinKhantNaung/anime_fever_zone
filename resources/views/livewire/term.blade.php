    ...
    <section class="w-full md:w-2/3 flex flex-col px-3 overflow-hidden">
        ...
        <div class="my-3">
            ...
            <p class="text-lg font-medium mt-5 text-gray-700">
                ...
                use Anime Fever Zone if you do not accept all of the terms and conditions stated on this page.
                <br><br>
                ...
                the Client or ourselves. All terms refer to the offer, acceptance and consideration of payment necessary
                to undertake the process of our assistance to the Client in the most appropriate manner, whether by
                formal meetings of a fixed duration, or any other means, for the express purpose of meeting the Client's
                needs in respect of provision of the Company's stated services/products, in accordance with and subject
                to, prevailing law of United States. Any use of the above terminology or other words in the singular,
        ...
        <div class="my-3">
            ...
            <p class="text-lg font-medium mt-5 text-gray-700">
                ...
                the views or opinions of Anime Fever Zone, its agents or affiliates. Comments reflect the view and
                opinion of the person who posts such view or opinion. To the extent permitted by applicable laws Anime
                Fever Zone shall not be responsible or liable for the Comments or for any loss cost, liability, damages
                or expenses caused and or suffered as a result of any use of and/or posting of and/or appearance of the
                Comments on this website.
                <br><br>
                Anime Fever Zone reserves the right to monitor all Comments and to remove any Comments which it
            ...
            <ul class="list-disc list-inside text-gray-700">
                ...
                <li>
                    The Comments do not infringe any intellectual property right, including without limitation
                    copyright, patent or trademark, or other proprietary right of any third party;
                </li>
                <li>
        ...
        <div class="my-3">
            ...
            <ul class="list-disc list-inside text-gray-700">
                ...
                <li>
                    ...
                    same manner as they hyperlink to the Web sites of other listed businesses; and
                </li>
                <li>
            ...
            <p class="text-lg font-medium mt-5 text-gray-700">
                ...
                the benefit to us from the visibility associated with the hyperlink outweighs the absence of ; and (d)
                ...
                No use of Anime Fever Zone's logo or other artwork will be allowed for linking absent a trademark
                license agreement.
            </p>
        </div>
