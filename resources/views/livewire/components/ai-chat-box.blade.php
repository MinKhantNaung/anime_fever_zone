...
Ask me anything about anime, posts, or the site!`,
    ...
    async sendMessage() {
        ...
        try {
            ...
            this.messages[assistantIndex].content = 'Sorry, I hit a snag. Please try again.';
        } finally {
    ...
    <div x-show="isOpen" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="flex-1 overflow-y-auto p-3 sm:p-4 bg-gray-50 space-y-4" x-ref="messages">
            <template x-for="(message, index) in messages" :key="index">
                <div class="flex items-start gap-3" :class="message.role === 'user' ? 'justify-end' : ''">
                    ...
                    <div class="max-w-[80%] border-red-500">
