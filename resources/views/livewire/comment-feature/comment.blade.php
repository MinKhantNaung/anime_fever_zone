                ...
                <footer class="flex justify-between items-center mb-1">
                    ...
                    <div class="flex items-center">
                        <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white"><img
                                ...
                                src="{{ optional($comment->user)->media ? optional($comment->user)->media->url : $comment->user->avatar() }}"
        ...
        @if ($hasReplies)
            ...
            <article class="p-1 mb-1 ml-1 lg:ml-12 border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                @foreach ($comment->children as $child)
                    <livewire:comment-feature.comment :comment="$child" :isReplying="false" :hasReplies="false"
                        :key="$child->id" />
                @endforeach
            </article>
        @endif
