<div class="container mx-auto flex flex-wrap py-6">
    ...
    <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        ...
        <article class="flex flex-col my-4 w-full">
            ...
            <!-- Article Image -->
            <img src="{{ $post->media->url }}" alt="Image representing {{ $post->heading }}" class="w-full" decoding="async">
            <!-- Post Description -->
                ...
                @foreach ($post->sections as $section)
                    ...
                    <div class="text-center mt-3 text-black">
                        <form wire:submit.prevent="removeSection({{ $section->id }})">
                            ...
                            @csrf
                            <a href="{{ route('sections.edit', $section->id) }}" class="inline-block cursor-pointer">
                                {{-- Edit button --}}
