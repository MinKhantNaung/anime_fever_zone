...
<div class="w-full" id="{{ str_replace(' ', '-', $section->heading) }}">
    ...
    <h2 class="font-bold text-2xl sm:text-3xl my-3 text-black">{{ $section->heading }}</h2>
    ...
    <div class="my-2 max-w-lg mx-auto">
        ...
        <div x-data="{
            ...
            new Swiper($el, {
                ...
                loop: slides.length === 1 || slides.length === 0 ? false : true,
                        ...
                        @switch($file->mime)
                            ...
                            @case('image')
                                <img src="{{ $file->url }}" alt="image"
                                    class="w-full block object-scale-down" loading="lazy" decoding="async">
                            @break
